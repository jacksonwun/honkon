...
AWS_S3_STORAGE_BUCKET_BACKEND_STATIC = os.getenv('AWS_S3_STORAGE_BUCKET_BACKEND_STATIC')
AWS_S3_FILE_OVERWRITE = False
AWS_DEFAULT_ACL = None
AWS_S3_OBJECT_PARAMETERS = { 'CacheControl': 'max-age=86400', }
AWS_S3_REGION_NAME = os.getenv('AWS_S3_REGION_NAME')
AWS_S3_CUSTOM_DOMAIN = '%s.s3.%s.amazonaws.com' % (AWS_S3_STORAGE_BUCKET_BACKEND_STATIC, AWS_S3_REGION_NAME)
AWS_LOCATION = ''
