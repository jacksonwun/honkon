...
from .views.suggestion import article_suggest_view
...
urlpatterns = [
    ...
    path('featureslide/', featureslide_list_view, name='feature-slide'),
    path('ArticleSuggestions/', article_suggest_view, name='suggestion-list'),
    # Article
